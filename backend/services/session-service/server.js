...
app.get('/api/sessions/websocket/status', (req, res) => {
  try {
    const stats = {
      connectedClients: collaborationService ? collaborationService.io.engine.clientsCount : 0,
      namespaces: {
        video: collaborationService ? collaborationService.videoNamespace.sockets.size : 0,
        whiteboard: collaborationService ? collaborationService.whiteboardNamespace.sockets.size : 0,
        code: collaborationService ? collaborationService.codeNamespace.sockets.size : 0,
        chat: collaborationService ? collaborationService.chatNamespace.sockets.size : 0
      },
      activeSessions: collaborationService ? collaborationService.activeSessions.size : 0,
