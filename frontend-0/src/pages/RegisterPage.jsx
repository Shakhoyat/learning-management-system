...
import { EyeIcon, EyeSlashIcon, BookOpenIcon, CheckIcon, XMarkIcon } from '@heroicons/react/24/outline';
            ...
            <div className="sm:mx-auto sm:w-full sm:max-w-md">
                <div className="flex justify-center">
                    <Link to="/" className="flex items-center">
                        ...
                        <span className="ml-3 text-3xl font-bold text-gray-900">EduMentor</span>
                    </Link>
                </div>
                        ...
                        <div>
                            ...
                            <div className="mt-1">
                                ...
                                >
                                    ...
                                    <option value="tutor">Tutor (ready to teach)</option>
                                </select>
                            </div>
                        </div>
