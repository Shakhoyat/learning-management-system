...
import DetailedTeachingAnalytics from '../components/analytics/DetailedTeachingAnalytics';
    ...
    return (
        <div className="min-h-screen bg-gradient-to-br from-gray-50 via-blue-50 to-indigo-50">
            ...
            <div className="max-w-7xl mx-auto py-6 sm:px-6 lg:px-8">
                        ...
                        <div className="flex flex-wrap gap-2">
                            {user?.role === 'tutor' && (
                                <button
                                    ...
                                    className={`px-5 py-2.5 rounded-xl text-sm font-semibold transition-all duration-200 transform hover:scale-105 ${showDetailed
                                            ? 'bg-gradient-to-r from-purple-600 to-pink-600 text-white shadow-lg shadow-purple-500/50'
                                            : 'bg-white text-gray-700 hover:bg-gray-50 border-2 border-gray-200 hover:border-purple-300'
                                        }`}
                                >
                                    {showDetailed ? '📊 Detailed View' : '📈 Overview'}
                                </button>
                            )}
                ...
                {/* Show Detailed Teaching Analytics for Tutors if enabled */}
                {user?.role === 'tutor' && showDetailed ? (
                    <div className="px-4 sm:px-0">
                        <DetailedTeachingAnalytics />
                    </div>
                ) : (
                    <>
                        {/* Overview Stats */}
